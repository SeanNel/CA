...
public final class StdDraw implements ActionListener, MouseListener,
	...
	private static final double BORDER = 0.0; // 0.05;
	...
	// Sean: changed private to public
	...
	// Sean: changed from private to public
	...
	public static void picture(double x, double y, Image image) {
		...
		int hs = image.getHeight(null);
		if (ws < 0 || hs < 0) {
			throw new RuntimeException("image is corrupt");
		}
