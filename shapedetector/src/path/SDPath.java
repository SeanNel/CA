...
public class SDPath implements Iterable<Point2D> {
	/** Internal representation of this path. */
	protected List<Point2D> vertices;
	/** Bounding rectangle. */
	protected Rectangle2D bounds;
	// /** Centre of gravity. */
	// protected Point2D centroid;
	// /** Surface area. Includes any enveloped shapes. */
	 ...
	 * oueline.
	 */
	// protected PathOutlineMap outlineMap;
	 ...
	 * Constructor.
	 */
	public SDPath(final Collection<Point2D> vertices) {
	 ...
	 * @param vertices
	 */
	public void addVertices(final Collection<Point2D> vertices) {
	...
	public static SDPath fromCells(final Collection<Cell> cells) {
		Collection<Point2D> vertices = new ArrayList<Point2D>(cells.size());
		for (Cell cell : cells) {
			int[] coordinates = cell.getCoordinates();
			vertices.add(new Point2D.Double(coordinates[0], coordinates[1]));
		}
	...
	public Point2D getCentroid() {
		 ...
		 */
		/*
		 * Gets the centre of the bounding rectangle. Not useful for shapes such
		 * as triangles.
		 */
		// getBounds();
	...
	// return getPathOutlineMap().getPerimeter();
	// }
	...
	// * @return
	// */
	// public PathOutlineMap getPathOutlineMap() {
	// if (outlineMap == null) {
	// outlineMap = new PathOutlineMap(this);
	// }
	// return outlineMap;
	// }
	...
	public VertexIterator iterator() {
		return new VertexIterator(vertices, VertexIterator.Direction.FORWARD,
				false);
	}
	...
	public void move(final double x, final double y) {
		...
		// getCentroid();
		// centroid.setLocation(centroid.getX() + x - x0, centroid.getY() + y -
		// y0);
	...
	/**
	 * // * Gets the vertices that correspond to distances from the starting
	 * point // * that are listed in <code>indices</code>. // * // * @param
	 * indices // * @return //
	 */
	// public List<Point2D> getVertices(final List<Double> indices) {
	// PathOutlineMap outlineMap = getPathOutlineMap();
	// int n = indices.size();
	 ...
	 * @return
	 */
	public static SDPath getPath(final Collection<Cell> cells) {
